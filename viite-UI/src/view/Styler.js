...
(function(root) {
  root.Styler = function() {
      ...
      if (anomaly !== 1) {
        if(constructionType === 1) {
          ...
          switch (roadClass) {
            ...
            case 4 :
              return 'rgba(0, 17, 187, 1)';
            case 5 :
              return 'rgba(51, 204, 204, 1)';
            case 6 :
              return 'rgba(224, 29, 217, 1)';
            case 7 :
              return 'rgba(0, 204, 221, 1)';
            case 8 :
              return 'rgba(136, 136, 136, 1)';
            case 9 :
              return 'rgba(255, 85, 221, 1)';
            case 10 :
              return 'rgba(255, 85, 221, 1)';
            case 11 :
    ...
    var generateStyleByFeature = function(roadLinkData, currentZoom){
      var strokeColor = generateStrokeColor(roadLinkData.roadClass, roadLinkData.anomaly, roadLinkData.constructionType);
